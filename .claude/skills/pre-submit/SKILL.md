...
## 1.5 🔴 is there a market standard to build against?

**Check `vault/wiki/` for all four market-standards pages, and check their `stale_after` has not passed.**

**If missing or stale, say so plainly — name the page and why it matters for the artefacts about to be submitted**
