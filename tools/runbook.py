...
RADAR = [
    ...
    ("archive the posting text — the EMPLOYER's copy where they run Oracle",
     "python3 tools/radar/archive_posting.py <careers URL>",
     "🔴 raw.json is overwritten every run. One req number went a week unarchived and onto a sent CV."),
    ("log it",
